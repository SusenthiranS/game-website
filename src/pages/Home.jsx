...
const Home = () => {
  ...
  const handleChangePage = () => {
    navigate(ROUTES.SINGLE_PLAYER_GAMES);
  };

  return (
    <div className="w-full flex flex-col justify-start items-center">
      <div className="flex flex-col items-center justify-center gap-6 p-8">
        <span className="text-4xl text-center sm:text-left sm:text-5xl font-bold">Play with Friends</span>
        <span className="text-4xl text-center sm:text-left sm:text-5xl font-bold text-cyan-500">
          Online --- Instantly
        </span>
      </div>
      <div className="flex flex-col items-center justify-center w-[85%] md:w-[60%] lg:w-[40%] text-justify">
      ...
      <div className="flex flex-wrap w-full items-center p-10 gap-8 justify-center">
        <div
          onClick={() => handleChangePage()}
          className="bg-gray-800 border-gray-600 cursor-pointer hover:scale-110 duration-200 px-4 py-6 w-72 border rounded-lg flex flex-col items-center justify-around gap-2"
        >
          ...
          <span className="text-center text-xl font-bold">Single Player Games</span>
        ...
        <div className="bg-gray-800 border-gray-600 cursor-pointer hover:scale-110 duration-200 px-4 py-6 w-72 border rounded-lg flex flex-col items-center justify-around gap-2">
          ...
          <span className="text-center text-xl font-bold">Real-time Multiplayer</span>
          <span className="text-center text-gray-400">
        ...
        <div className="bg-gray-800 border-gray-600 cursor-pointer hover:scale-110 duration-200 px-4 py-6 w-72 border rounded-lg flex flex-col items-center justify-around gap-2">
          ...
          <span className="text-center text-xl font-bold">Multiple Games</span>
          <span className="text-center text-gray-400">
